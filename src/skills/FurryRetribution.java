...
public class FurryRetribution extends ASkills {
    public FurryRetribution(String nameSkill, float damage, float accuracy) {
        super(nameSkill, damage, accuracy);
    }

    public FurryRetribution() {
        super("Пушистое возмездие", 8, 0.44f);
    } //оглушает на 1 ход
